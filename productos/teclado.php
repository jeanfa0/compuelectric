...
<head>
  ...
  <title>Teclados | CompuElectric</title>
...
<body>
  ...
  <section class="hero-int">
    ...
    <div class="container">
      ...
      <h1>⌨️ <span>Teclados</span></h1>
    </div>
  </section>

  <main>
    <h2>Productos: <span>Teclados</span></h2>
    <div class="productos-grid">
      <div class="producto reveal">
        <img src="../img/J8F14AA-1_T1678968439.avif" alt="Teclado Normal">
        <h3>Teclado Normal Redragon</h3>
        <p>USB · RGB</p>
        <h5>S/.24</h5>
      ...
      <div class="producto reveal" style="transition-delay:.08s">
        <img src="../img/tecladogamer.webp" alt="Teclado Gamer">
        <h3>Teclado Gamer Mecánico</h3>
        <p>RGB 60% · Switch azul</p>
        <h5>S/.99</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.16s">
        <img src="../img/tecladonormal.webp" alt="Teclado Logitech K120">
        <h3>Logitech K120</h3>
        <p>USB · Teclado numérico</p>
        <h5>S/.59</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.24s">
        <img src="../img/tecladoblanco.png" alt="Kit Teclado + Mouse">
