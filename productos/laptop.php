...
<head>
  ...
  <title>Laptops | CompuElectric</title>
...
<body>
  ...
  <section class="hero-int">
    ...
    <div class="container">
      ...
      <h1>💻 <span>Laptops</span></h1>
    </div>
  </section>

  <main>
    <h2>Productos: <span>Laptops</span></h2>
    <div class="productos-grid">
      <div class="producto reveal">
        <img src="../img/laptop1.png" alt="Laptop Lenovo">
        <h3>Laptop Lenovo</h3>
        <p>RAM: 16GB · 512GB SSD · Intel Core i5 · FHD</p>
        <h5>S/.1,299</h5>
      ...
      <div class="producto reveal" style="transition-delay:.08s">
        <img src="../img/laptopgamer.png" alt="Laptop Gamer">
        <h3>Laptop Gamer</h3>
        <p>15.6" · RAM 8GB · 512GB SSD · Intel Core i5</p>
        <h5>S/.967</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.16s">
        <img src="../img/officelaptop.png" alt="Laptop Office">
        <h3>Laptop Office</h3>
        <p>15" · Windows 11 · Procesador Deca-core</p>
        <h5>S/.2,099</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
    </div>
