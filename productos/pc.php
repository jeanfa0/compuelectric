...
<body>
  ...
  <section class="hero-int">
    ...
    <div class="container">
      ...
      <h1>🖥️ <span>PC</span></h1>
    </div>
  </section>

  <main>
    <h2>Productos: <span>PC</span></h2>
    <div class="productos-grid">
      <div class="producto reveal">
        <img src="../img/pc.PNG" alt="PC Gamer Micronics">
        <h3>PC Gamer Micronics</h3>
        <p>Pantalla curva · FHD 1920x1080 · 100Hz</p>
        <h5>S/.454</h5>
      ...
      <div class="producto reveal" style="transition-delay:.08s">
        <img src="../img/pcgamer.PNG" alt="PC Gamer 27">
        <h3>PC Gamer 27"</h3>
        <p>FHD 1920x1080 · Micronics</p>
        <h5>S/.627</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.16s">
        <img src="../img/pcrainbow.PNG" alt="PC Gamer Rainbow">
        <h3>PC Gamer Rainbow</h3>
        <p>24" · FHD · 75Hz · Micronics</p>
        <h5>S/.627</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.24s">
        <img src="../img/pc.PNG" alt="PC Gamer Extra">
        <h3>PC Gamer Extra</h3>
        <p>Ryzen · 16GB RAM · RTX 3060</p>
        <h5>S/.1,200</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
    </div>
