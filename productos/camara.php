...
<head>
  ...
  <title>Cámaras Web | CompuElectric</title>
...
<body>
  ...
  <section class="hero-int">
    ...
    <div class="container">
      ...
      <h1>📷 <span>Cámaras Web</span></h1>
    </div>
  </section>

  <main>
    <h2>Productos: <span>Cámaras Web</span></h2>
    <div class="productos-grid">
      <div class="producto reveal">
        <img src="../img/Camara web.png" alt="Cámara Full HD">
        <h3>Cámara Web Logitech C270</h3>
        <p>Tipo: Cámara web · Resolución: HD 1080p</p>
        <h5>S/.99</h5>
      ...
      <div class="producto reveal" style="transition-delay:.08s">
        <img src="../img/caramaHD.png" alt="Cámara HD">
        <h3>Webcam HD con Micrófono</h3>
        <p>Resolución: HD+ · Cámara: 2.1 MP</p>
        <h5>S/.35</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.16s">
        <img src="../img/CamaraWeb2.png" alt="Logitech C925e">
        <h3>Logitech C925e</h3>
        <p>Resolución: Full HD · 108 MP</p>
        <h5>S/.399</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.24s">
        <img src="../img/Camarastream.png" alt="Logitech C922 Pro">
        <h3>Logitech C922 Pro Stream</h3>
        <p>Resolución: FHD · 0.3 MP</p>
        <h5>S/.389</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
    </div>
