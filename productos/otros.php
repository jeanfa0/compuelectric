...
<head>
  ...
  <title>Otros Productos | CompuElectric</title>
...
<body>
  ...
  <section class="hero-int">
    ...
    <div class="container">
      ...
      <h1>🧰 <span>Otros Productos</span></h1>
    </div>
  </section>

  <main>
    <h2>Productos: <span>Otros Productos</span></h2>
    <div class="productos-grid">
      <div class="producto reveal">
        <img src="../img/cable1.png" alt="Cable THW-90">
        <h3>Cable THW-90 14AWG Rojo 100m</h3>
        <p>Indeco · PVC · 450/750V · 1 año garantía</p>
        <h5>S/.153.90</h5>
      ...
      <div class="producto reveal" style="transition-delay:.08s">
        <img src="../img/bolsacable.png" alt="Cable THW-90 6mm">
        <h3>Cable THW-90 6mm² Negro 100m</h3>
        <p>Indeco · PVC/Cobre</p>
        <h5>S/.679.90</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.16s">
        <img src="../img/cablenegro.png" alt="Cable Vulcanizado">
        <h3>Cable Vulcanizado 3X10AWG 100m</h3>
        <p>Indeco · PVC/Cobre · Negro</p>
        <h5>S/.679.90</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <div class="producto reveal" style="transition-delay:.24s">
        <img src="../img/camaraweb4k.png" alt="Cámara 2K">
        <h3>Cámara Web 2K con Trípode</h3>
        <p>Full HD · 2592px · Teros Te-9072</p>
        <h5>S/.89</h5>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
    </div>
