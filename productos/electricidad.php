<?php // electricidad.php ?>
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Electricidad | CompuElectric</title>
...
<body>
  ...
  <section class="hero-int">
    ...
    <div class="container">
      ...
      <h1>💡 <span>Electricidad</span></h1>
    </div>
  </section>

  <main>
    <h2>Productos: <span>Electricidad</span></h2>
    <div class="productos-grid">
      <!-- Producto 1 -->
      <div class="producto">
        <img src="https://via.placeholder.com/400x250?text=Producto+1" alt="Producto eléctrico 1">
        <h3>Producto Eléctrico 1</h3>
        <p>Descripción breve del producto eléctrico 1.</p>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <!-- Producto 2 -->
      <div class="producto">
        <img src="https://via.placeholder.com/400x250?text=Producto+2" alt="Producto eléctrico 2">
        <h3>Producto Eléctrico 2</h3>
        <p>Descripción breve del producto eléctrico 2.</p>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <!-- Producto 3 -->
      <div class="producto">
        <img src="https://via.placeholder.com/400x250?text=Producto+3" alt="Producto eléctrico 3">
        <h3>Producto Eléctrico 3</h3>
        <p>Descripción breve del producto eléctrico 3.</p>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <!-- Producto 4 -->
      <div class="producto">
        <img src="https://via.placeholder.com/400x250?text=Producto+4" alt="Producto eléctrico 4">
        <h3>Producto Eléctrico 4</h3>
        <p>Descripción breve del producto eléctrico 4.</p>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <!-- Producto 5 -->
      <div class="producto">
        <img src="https://via.placeholder.com/400x250?text=Producto+5" alt="Producto eléctrico 5">
        <h3>Producto Eléctrico 5</h3>
        <p>Descripción breve del producto eléctrico 5.</p>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <!-- Producto 6 -->
      <div class="producto">
        <img src="https://via.placeholder.com/400x250?text=Producto+6" alt="Producto eléctrico 6">
        <h3>Producto Eléctrico 6</h3>
        <p>Descripción breve del producto eléctrico 6.</p>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <!-- Producto 7 -->
      <div class="producto">
        <img src="https://via.placeholder.com/400x250?text=Producto+7" alt="Producto eléctrico 7">
        <h3>Producto Eléctrico 7</h3>
        <p>Descripción breve del producto eléctrico 7.</p>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
      <!-- Producto 8 -->
      <div class="producto">
        <img src="https://via.placeholder.com/400x250?text=Producto+8" alt="Producto eléctrico 8">
        <h3>Producto Eléctrico 8</h3>
        <p>Descripción breve del producto eléctrico 8.</p>
        <div class="botones"><button class="btn-compra">Comprar</button><button class="btn-compra">🛒</button></div>
      </div>
    </div>
  </main>
